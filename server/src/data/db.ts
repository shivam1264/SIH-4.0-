  ...
  studyMaterials: [
    {
      ...
      content: 'The Constitution of India is the supreme law of India. The document lays down the framework that demarcates fundamental political code, structure, procedures, powers, and duties of government institutions and sets out fundamental rights, directive principles, and the duties of citizens.\n\nPart III contains Fundamental Rights (Articles 12 to 35). Under Article 21, protection of life and personal liberty is guaranteed. The Supreme Court in the landmark K.S. Puttaswamy v. Union of India (2017) judgment affirmed that Right to Privacy is a fundamental right protected under Article 21.\n\nUnder Article 32, citizens can directly petition the Supreme Court for enforcement of fundamental rights using five prerogative writs:\n1. Habeas Corpus: To release a person from unlawful detention.\n2. Mandamus: Command to a public authority to perform a statutory duty.\n3. Prohibition: Issued by a higher court to prevent an inferior court from exceeding jurisdiction.\n4. Certiorari: To quash an order issued without jurisdiction or with error of law.\n5. Quo-Warranto: To challenge the legal authority of a person holding a public office.',
      keyPoints: [
        ...
        'Fundamental Rights are justiciable in High Courts (Art. 226) and Supreme Court (Art. 32)'
      ],
    ...
    },
    {
      ...
      content: 'In competitive examinations like SSC CGL and Banking, percentage and profit-loss questions form over 25% of the quantitative aptitude section.\n\nKey Concepts:\n1. Multiplier Method:\n- To increase a number by x%, multiply by (1 + x/100).\n- To decrease a number by x%, multiply by (1 - x/100).\n\n2. Expenditure Invariance Rule:\nIf the price of a commodity increases by R%, consumption must be reduced by [R / (100 + R)] * 100% so that expenditure remains unchanged.\n\n3. Profit and Loss:\n- Cost Price (CP): Original price of an item.\n- Selling Price (SP): Price at which an item is sold.\n- Profit = SP - CP. Profit Percentage = (Profit / CP) * 100.\n- Loss = CP - SP. Loss Percentage = (Loss / CP) * 100.\n- Marked Price (MP) and Discount: Discount Percentage is always calculated on Marked Price.',
      keyPoints: [
    ...
    try {
      if (fs.existsSync(DATA_FILE)) {
        ...
        return {
          ...INITIAL_DATA,
          ...parsed,
          studyMaterials: Array.isArray(parsed.studyMaterials) && parsed.studyMaterials.length
            ? parsed.studyMaterials
            : INITIAL_DATA.studyMaterials,
          pyqs: Array.isArray(parsed.pyqs) && parsed.pyqs.length
            ? parsed.pyqs
            : INITIAL_DATA.pyqs,
        };
      }
