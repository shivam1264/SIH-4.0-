...
class DrishtiNluService {
  ...
  public async understand(
    ...
    const deterministicActions = new Set([
      ...
      'OPEN_LOGIN', 'DEMO_STUDENT_LOGIN', 'DEMO_ADMIN_LOGIN', 'OPEN_REGISTER', 'OPEN_ADMIN',
      'VERIFY_ANSWER', 'PRACTICE_HINT', 'PRACTICE_RETRY', 'PRACTICE_TOPIC',
      'FILTER_CATEGORY', 'FILTER_DIFFICULTY', 'RESET_FILTERS',
